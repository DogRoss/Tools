...
public class CameraPhysics : MonoBehaviour
{
    ...
    public void ApplyForce()
    {
        ...
        movementInputVector = movementDynamics.UpdateDynamics(Time.fixedDeltaTime, movementInputVector);
        ...
        rotationInputVector = rotationDynamics.UpdateDynamics(Time.fixedDeltaTime, rotationInputVector) * rotationScale;
